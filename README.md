...
- Aviasales-ссылки формируются на backend: точные даты используют compact search path, месяц и гибкое окно — route page, а affiliate marker при наличии читается из `AVIASALES_MARKER`.
