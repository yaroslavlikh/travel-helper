...
- Aviasales-ссылки формируются на backend: примерный диапазон не отправляется как точные даты, а affiliate marker при наличии читается из `AVIASALES_MARKER`.
